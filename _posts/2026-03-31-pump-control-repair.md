...
{% include img.html src="/assets/images/connector_status_before.jpg" alt="Connector status before repair" caption="Connector status before repair - heavy rusting" %}
...
{% include img.html src="/assets/images/new_connectors.jpg" alt="New Connectors" caption="New Connectors" %}
...
{% include img.html src="/assets/images/starter_wiring_diagram.jpg" alt="Control Panel Wiring Diagram" caption="Control Panel Wiring Diagram" %}
...
{% include img.html src="/assets/images/connector_closeup.jpg" alt="Connector closeup" caption="Rusted Connector - closeup" %}
...
{% include img.html src="/assets/images/connector_status_after.jpg" alt="Connector status after repair" caption="With New Terminal Connector" %}
